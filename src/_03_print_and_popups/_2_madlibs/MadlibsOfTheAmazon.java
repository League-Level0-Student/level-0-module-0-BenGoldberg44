...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("pls type adjective");
		// Get the player to enter a type of liquid
		String watar = JOptionPane.showInputDialog(" write watar");
		// Get the player to enter a body part
		String arm = JOptionPane.showInputDialog("write arm");
		...
		"night. Piranhas are attracted to fresh "+ watar +" and will most\n"  +
